...
def optimize(intial_val, vel, tspan, intial_constants, c_robust, c_response, max_torque, max_response, min_robust):
    ...
    #     range_torque = (PIDPhi(k_p=x[0], k_i=x[1], k_d=x[2]).get_control(goals=None))(t=0, e=e, v=vel)
    ...
    res = minimize(objective, intial_constants)

    return res.x


if __name__ == '__main__':
    optimize(intial_val=[10, 0, 0, 0], vel=6, tspan=60, intial_constants=[5, .00000001, 0], c_robust=1, c_response=1,
